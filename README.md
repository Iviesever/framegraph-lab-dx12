...
Version 0.1 is under development. The pure compiler/planner and native hardware/WARP clear/present foundation are verified. The placed-resource executor and HDR demo are the next gates. See the [product contract](tasks/20260904-184500-framegraph-dx12-0.1/product_contract.md) and [progress](tasks/20260904-184500-framegraph-dx12-0.1/progress.md) for exact evidence.
