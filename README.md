...
See [build policy](docs/BUILDING.md) for shared MQB/CMake configuration and portable commands. Binary packaging and repeated clean-extraction validation are release gates. The release uploads only the Win64 ZIP, its SHA-256 file, and Delivery Manifest; GitHub supplies the source ZIP/tar.gz automatically.
