...
| Performance | raw compile/allocation/barrier and native alias samples/medians | 31×1000 Core samples; compile -23.50%, barrier -6.77%, identity/counts stable; 7 paired native samples |
