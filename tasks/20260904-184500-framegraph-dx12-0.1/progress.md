...
The 1280x720 120-frame hardware observation reports logical/reference/actual heap bytes 16,589,456 / 17,825,792 / 13,893,632, saving 3,932,160 (22.06%). GPUFrustumCulling averaged 0.0221 ms locally; this is an observation, not an SLA. PACT-70 checkpoint/push, final P0 recertification, package/manifest update, CI, PR refresh and post-change audit remain before final delivery. Tier 2 begins only after this PACT is checkpointed green.
