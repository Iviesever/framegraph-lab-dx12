...
- [ ] PACT-50 through 80: follow blueprint order, write each concrete acceptance test before the respective production change and append commands/results to evidence. Update this checklist as contracts land.
